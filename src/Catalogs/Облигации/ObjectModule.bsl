...
Процедура ОчиститьОбъект()
	BOARDID = Неопределено;
	COUPONDATE = Неопределено;
	COUPONFREQUENCY = Неопределено;
	COUPONPERCENT = Неопределено;
	COUPONVALUE = Неопределено;
	DAYSTOREDEMPTION = Неопределено;
	EARLYREPAYMENT = Неопределено;
	EMITTER_ID = Неопределено;
	FACEUNIT = Неопределено;
	FACEVALUE = Неопределено;
	GROUP = Неопределено;
	GROUPNAME = Неопределено;
	INITIALFACEVALUE = Неопределено;
	ISIN = Неопределено;
	ISQUALIFIEDINVESTORS = Неопределено;
	ISSUEDATE = Неопределено;
	ISSUESIZE = Неопределено;
	LATNAME = Неопределено;
	LISTLEVEL = Неопределено;
	MATDATE = Неопределено;
	NAME = Неопределено;
	PROGRAMREGISTRYNUMBER = Неопределено;
	REGNUMBER = Неопределено;
	SECID = Неопределено;
	SHORTNAME = Неопределено;
	STARTDATEMOEX = Неопределено;
	TYPE = Неопределено;
